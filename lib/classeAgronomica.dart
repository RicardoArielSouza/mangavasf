...
class ClasseAgronomicaPage extends StatefulWidget {
  const ClasseAgronomicaPage({Key? key}) : super(key: key);

  @override
  State<ClasseAgronomicaPage> createState() => _ClasseAgronomicaPageState();
}

class _ClasseAgronomicaPageState extends State<ClasseAgronomicaPage> {
              ...
              child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: Image.asset(
                        'assets/images/classe_agronomica.png',
                        width: 180.0,
                      ),
                    ),
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Container(
                            alignment: Alignment.centerLeft,
                            child: Text(
                              'Produtos Formulados por Classe Agronômica',
