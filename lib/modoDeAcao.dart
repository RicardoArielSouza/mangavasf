...
class ModoDeAcaoPage extends StatefulWidget {
  const ModoDeAcaoPage({Key? key}) : super(key: key);

  @override
  State<ModoDeAcaoPage> createState() => _ModoDeAcaoPageState();
}

class _ModoDeAcaoPageState extends State<ModoDeAcaoPage> {
              ...
              child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: Image.asset(
                        'assets/images/modo_de_acao.png',
                        width: 180.0,
                      ),
                    ),
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Container(
                            alignment: Alignment.centerLeft,
                            child: Text(
                              'Produtos Formulados por Modo de Ação',
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton(
                    ...
                    items: [
                      ...
                      DropdownMenuItem(
                        child: Text('Profundidade'),
                        value: 'Profundidade',
                      ),
                      DropdownMenuItem(
                        child: Text('Fumigante'),
                        value: 'Fumigante',
                      ),
                      DropdownMenuItem(
                        child: Text('Sistêmico'),
                        value: 'Sistêmico',
                      ),
                      DropdownMenuItem(
                        child: Text('Mesosistêmico'),
                        value: 'Mesosistêmico',
                      ),
                    ],
                    onChanged: (value) {},
