...
class ProdutosFormuladosPage extends StatefulWidget {
  const ProdutosFormuladosPage({Key? key}) : super(key: key);

  @override
  State<ProdutosFormuladosPage> createState() => _ProdutosFormuladosPageState();
}

class _ProdutosFormuladosPageState extends State<ProdutosFormuladosPage> {
              ...
              child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: Image.asset(
                        'assets/images/produtos_formulados.png',
                        width: 180.0,
                      ),
                    ),
                    Container(
