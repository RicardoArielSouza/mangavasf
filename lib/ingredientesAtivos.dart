...
class IngredientesAtivosPage extends StatefulWidget {
  const IngredientesAtivosPage({Key? key}) : super(key: key);

  @override
  State<IngredientesAtivosPage> createState() => _IngredientesAtivosPageState();
}

class _IngredientesAtivosPageState extends State<IngredientesAtivosPage> {
              ...
              child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: Image.asset(
                        'assets/images/ingredientes_ativos.png',
                        width: 180.0,
                      ),
                    ),
                    Container(
